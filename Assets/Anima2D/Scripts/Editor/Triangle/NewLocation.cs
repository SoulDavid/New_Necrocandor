...
namespace TriangleNet
{
    ...
    class NewLocation
    {
            ...
            ref double xi, ref double eta, bool offcenter, Otri badotri)
        {
            ...
            // keeps the radiusCamera of petal
            double petalRadius;
            ...
            //   serves as a conservative estimate of the insertion radiusCamera of the
            ...
            if (almostGood == 1)
            {
                ...
                {
                    // calculate radiusCamera of the petal according to angle constraint
                    // first find the visible region, PETAL
                    // find the center of the circle and radiusCamera
        ...
        /// <summary>
        /// Given two points representing a line and  a radiusCamera together with a center point 
            ...
            double x3, double y3, double r, ref double[] p)
        {
            // x1,y1  P1 coordinates [point of line]
            // x2,y2  P2 coordinates [point of line]
            // x3,y3, r  P3 coordinates(circle center) and radiusCamera [circle]	
